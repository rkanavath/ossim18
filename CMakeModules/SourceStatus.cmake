...
function(repository_status root_repo_dir result_var1 result_var2)
  ...
  set(${result_var2} ${VCS_REVISION} PARENT_SCOPE)
  
  message(STATUS "Repository status (${dir_name}) :")
  message(STATUS "  Repository revision is ${VCS_REVISION}")

  execute_process(COMMAND ${GIT_EXECUTABLE} status -s
    WORKING_DIRECTORY ${root_repo_dir}
    OUTPUT_VARIABLE VCS_STATUS
    TIMEOUT 20
    OUTPUT_STRIP_TRAILING_WHITESPACE ERROR_QUIET)

  if(VCS_STATUS)
    message(STATUS "  Local file modifications (${dir_name}) :")
    string(REPLACE "\n" "\n--     " VCS_STATUS_PRETTYPRINT "    ${VCS_STATUS}")
    message(STATUS "${VCS_STATUS_PRETTYPRINT}")
  else()
